...
function Feedback2() {
  ...
  const feedbackData = sections?.feedbacks || {};
  ...
  return (
    <div style={{ backgroundColor: themeColor1}}>
      <AnimatedSection>
    <div 
      className="relative flex flex-col lg:flex-row-reverse items-center py-15 lg:justify-between lg:px-60"
    ...
    >
      ...
      <div className="w-full flex justify-center items-center">
        <h1
          className="text-4xl font-medium pb-8 leading-snug text-center lg:text-right whitespace-pre-line"
          style={{ color: textColor1 }}
        >
          {feedbackData.section_name || 'وش قالوا عنا؟'}
        </h1>
      </div>
      ...
      <div className="relative w-full h-[400px] flex items-center justify-center">
        {/* خلفيات الكرت */}
        <div
          className="absolute w-[320px] h-full rounded-lg shadow-lg transform rotate-[7deg] scale-95 z-0 opacity-30"
          style={{ backgroundColor: textColor1 }}
        ></div>
        <div
          className="absolute w-[320px] h-full rounded-lg shadow-lg transform rotate-[-10deg] scale-95 z-0 opacity-60"
          style={{ backgroundColor: textColor1 }}
        ></div>
        ...
        {currentReview && (
          <div key={currentReview.id} className="relative z-10 w-[295px] h-full" >
            <div
              className="rounded-lg shadow-xl flex flex-col justify-between h-full"
